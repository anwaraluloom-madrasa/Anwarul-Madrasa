              ...
              .map((author) => (
                ...
                >
                    ...
                    <div className="flex justify-center">
                      <div className="relative h-40 w-40 overflow-visible">
                        ...
                        <div
                          ...
                          `}
                        >
                          <div className={`h-2 w-2 rounded-full ${author.is_alive ? "bg-white" : "bg-white"}`}></div>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="text-center space-y-4 px-6 pt-2 pb-6 flex-1">
                    <h2 className="text-2xl font-bold text-gray-900 group-hover:text-emerald-700 transition-colors leading-tight" style={{ fontFamily: 'Amiri, serif' }}>
                    ...
                    <div
                      ...
                      dangerouslySetInnerHTML={{ __html: truncate(author.bio, 100) }}
                    />
                  </div>
