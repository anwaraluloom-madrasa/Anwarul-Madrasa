                    ...
                    <div className="order-1 lg:order-2">
                      <div className="flex items-center gap-4 mb-6">
                        ...
                        <h4
                          ...
                          style={{ fontFamily: "Amiri, serif" }}
                        >
                        د انوارالعلوم په نوم د يوې مدرسې د بنسټ ډبره په خپلو مبارکو لاسونو کېښوده
                        </h4>
                      </div>
                      <p
                        ...
                        style={{ fontFamily: "Amiri, serif" }}
                      >
کله چې حضرت خليفه صاحب نورالله مرقده د ظاهري او باطني علومو له تحصيل څخه فارغ شو، نو د دين د خدمت او د علم د خپرولو کاروان يې په لومړي ځل له ميدان وردګو ولايت د چارکي مدرسې څخه پيل کړ؛ چې په منظم او دوامداره ډول يې د تدريس ډیوې روښانه کړې. وروسته د کابل ولايت د پغمان ولسوالۍ د برې ارغندۍ سيمې د بازيدخېلو کلي ته ولاړ او همدلته يې په لومړي ځل د انوارالعلوم په نوم د یوې مدرسې ډبره په خپلو مبارکو لاسونو کېښوده چې د دیني او اخلاقي روزنې تر څنګ د روحاني تزکيې يو مهم مرکز وګرځېد او د سيمې د خلکو لپاره د هدايت، پوهې او معنويت يوه ستره سرچينه شوه؛ چې تر اوسه پورې وګړي ورڅخه خپله علمي،اخلاقي او روحاني تنده خړوبوي.
                      </p>
