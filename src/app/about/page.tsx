    ...
    <div className="relative py-8">
      ...
      <div className="text-center mb-8">
        <div className="inline-flex items-center justify-center gap-3 mb-6">
          ...
          >
            د انوارالمشائخ فضل الدین رح په باره کې د علماؤ،مشایخو کرامو، سیاسینو
            او ولسی وکړو نظری
          </h4>
        </div>
                ...
                <div className="relative py-8">
                  ...
                  <div className="text-center mb-8">
                    ...
                    <p
                      ...
                      style={{ fontFamily: "Amiri, serif" }}
                    >خلیفه صاحب قدس الله سره، د طالب‌العلمۍ په مبارکو شپو ورځو کې د حضرت نورالمشائخ فضل عمر مجددي قدس الله سره په سپېڅلو لاسونو بیعت وکړ او د سلوک پر لاره روان شو. کله چې حضرت نورالمشائخ، نور الله مرقده، له دارالفنا څخه دارالبقا ته رحلت وکړ؛ نو خلیفه صاحب د خپل عهد تجدید له حضرت ضیاءالمشائخ محمد ابراهیم جان مجددي نورالله مرقده سره وکړ. 
نوموړی په ۱۳۴۹ هـ.ش کال کې د علمِ باطن په فیوضاتو مشرف شو، د سلوک او طریقت منازل یې د الله پاک په توفیق بشپړ کړل؛ چې بلاخره د جناب حضرت ضیاءالمشائخ رح په مبارکو لاسونو د خلافت له روحاني مرتبې څخه برخمن او د نوموړي په مبارکو لاسونو ورته دستار وتړل شو.
                    </p>
                  </div>
                  <div className="absolute inset-x-0 bottom-0 h-px bg-gradient-to-r from-transparent via-[#4a8a8a]/20 to-transparent"></div>
                </div>
                    ...
                    <div className="order-1 lg:order-2">
                      <div className="flex items-center gap-4 mb-6">
                        ...
                        <h4
                          ...
                          style={{ fontFamily: "Amiri, serif" }}
                        >
                        د انوارالعلوم مدرسې د بنسټ ډبره
                        </h4>
                      </div>
                      <p
                        ...
                        style={{ fontFamily: "Amiri, serif" }}
                      >
کله چې حضرت خليفه صاحب نورالله مرقده د ظاهري او باطني علومو له تحصيل څخه فارغ شو، نو د دين د خدمت او د علم د خپرولو کاروان يې په لومړي ځل له ميدان وردګو ولايت د چارکي مدرسې څخه پيل کړ؛ چې په منظم او دوامداره ډول يې د تدريس ډیوې روښانه کړې. وروسته د کابل ولايت د پغمان ولسوالۍ د برې ارغندۍ سيمې د بازيدخېلو کلي ته ولاړ او همدلته يې په لومړي ځل د انوارالعلوم په نوم د يوې مدرسې د بنسټ ډبره په خپلو مبارکو لاسونو کېښوده چې د دیني او اخلاقي روزنې تر څنګ د روحاني تزکيې يو مهم مرکز وګرځېد او د سيمې د خلکو لپاره د هدايت، پوهې او معنويت يوه ستره سرچينه شوه؛ چې تر اوسه پورې وګړي ورڅخه خپله علمي،اخلاقي او روحاني تنده خړوبوي.
                      </p>
                ...
                <div className="relative py-12">
                  ...
                  <div className="text-center mb-8">
                    ...
                    <p
                      ...
                      style={{ fontFamily: "Amiri, serif" }}
                    >حضرت انوارالمشائخ رح د نور محمد تره‌کي د حکومت په وخت کې له خپل ګران هېواد څخه هجرت وکړ او د پاکستان د شمالي وزیرستان په میرانشاه سیمه کې یې د اوسېدو پرېکړه وکړه؛ که څه هم له وطنه لرې وه خو د هجرت په دې ټاټوبي کې یې یو ځل بیا د علم رڼا روښانه کړه او د انوارالعلوم الاسلامیة په نامه يې یوه منوره ديني مدرسه تأسیس کړه. دا مدرسه ډېر ژر د دیني زده کړو په یوه لوی مرکز بدله شوه، چې سلګونه طالب العلمانو به پکې د دیني علومو زده کړه کوله.
همدغه مدرسه د هغه د علمي او روحاني بصیرت، ديني غیرت او امت ته د خدمت د ژمنې یو ژوندی مثال وګرځېده او د هجرت په غربت کې یې د علم، تقوا او روحانیت داسې څراغ بل کړ چې رڼا یې تر لرې لرې سیمو پورې خپره شوه.
                    </p>
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    <div>
                      ...
                      <p
                        className="text-base md:text-lg leading-relaxed text-gray-700 px-4 sm:px-6"
                        style={{ fontFamily: "Amiri, serif" }}
                      > حضرت انوارالمشائخ خلیفه صاحب ارغندي قدس الله سره د خپل ژوند په وروستیو کلونو کې له یوې سختې او اوږدې ناروغۍ سره مخ شو؛ هماغه مرض يې د فاني ژوند د پای سبب وګرځېد او په ۱۹۹۵م کال کې یې خپل روح  حق جل جلاله ته وسپاره.
جنازه یې د پاکستان په میرانشاه سیمه د شهیدانو هدیرې ته څېرمه ادا او په یاده هدیره کې خاورو ته وسپارل شوه. د جنازې په مراسمو کې زرګونو علماوو، جهادي مشرانو،سیاسیونو،مجاهدینو او طالب العلمانو ګډون کړی و.
روح یې ښاد، په ګور يې نور او یاد دې تل تر تله ژوندی وي!
                      </p>
                    </div>
                    <div className="relative">
                      <div className="absolute -inset-4 bg-gradient-to-br from-[#4a8a8a]/10 to-transparent rounded-2xl blur-2xl"></div>
